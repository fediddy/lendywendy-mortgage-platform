...
export const metadata: Metadata = {
  ...
  description:
    "SBA 7(a) loans for California small businesses. Up to $5 million for real estate, equipment, and working capital. 10% down, 10-25 year terms. Government-backed with competitive rates. NMLS #1945913.",
  keywords: [
      ...
      <main className="min-h-screen bg-slate-950">
          ...
          <div className="container mx-auto px-4 relative">
            <div className="max-w-4xl mx-auto text-center">
              ...
              <nav className="flex justify-center items-center gap-2 text-sm text-gray-400 mb-6">
                ...
                <span>/</span>
                <span className="text-amber-500">SBA 7(a) Loans</span>
              </nav>
              ...
              <h1 className="text-4xl sm:text-5xl lg:text-6xl font-bold text-white leading-tight mb-6">
                California <span className="text-amber-500">SBA 7(a) Loans</span>
                <br />
              ...
              <div className="flex flex-col sm:flex-row gap-4 justify-center">
                ...
                >
                  <Link href="/get-quote">
                    Get SBA 7(a) Rates <ArrowRight className="ml-2 h-5 w-5" />
                  </Link>
                </Button>
                <Button
                  size="lg"
            ...
            <div className="max-w-4xl mx-auto">
              ...
              <div className="grid sm:grid-cols-2 gap-4">
                {eligibleUses.map((item, index) => (
                  ...
                  >
                    <h3 className="text-white font-semibold mb-2">{item.use}</h3>
        ...
        <section className="py-20 border-t border-slate-800 bg-gradient-to-b from-slate-900 to-slate-950">
          <div className="container mx-auto px-4 text-center">
            ...
            <p className="text-xl text-gray-400 mb-8 max-w-2xl mx-auto">
              Get matched with SBA Preferred Lenders who specialize in California small business
            ...
            >
              <Link href="/get-quote">
                Get SBA Pre-Qualified <ArrowRight className="ml-2 h-5 w-5" />
              </Link>
            </Button>
            <p className="text-sm text-gray-500 mt-4">
              NMLS #1945913 | SBA Lender Network Partner
            </p>
          </div>
        </section>
      </main>
