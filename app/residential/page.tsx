...
export const metadata: Metadata = {
  title: "Residential Mortgages | LendyWendy",
  description: "Expert guidance on residential mortgages, home loans, and refinancing options. Get the information you need to make informed decisions about your home financing.",
  openGraph: {
    title: "Residential Mortgages | LendyWendy",
    description: "Expert guidance on residential mortgages, home loans, and refinancing options.",
    type: "website",
  },
};
