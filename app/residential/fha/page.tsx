...
export const metadata: Metadata = {
  ...
  description:
    "Compare FHA loan rates in California with just 3.5% down and 580 credit score. Government-backed mortgages with low closing costs, gift funds allowed. First-time homebuyer friendly. Compare rates in 60 seconds.",
  keywords: [
    "FHA loan California",
  ...
  openGraph: {
    ...
    description:
      "Compare FHA mortgage rates for California homebuyers. 3.5% down with 580 credit. Government-backed, first-time buyer friendly.",
    type: "website",
...
const requirements = [
  ...
  { label: "Loan Limits (2026)", value: "$498,257 - $1,249,125" },
  { label: "MIP Required", value: "Yes, for life of loan" },
  { label: "Property Types", value: "Primary Residence Only" },
];

const californiaFhaLimits = [
  { county: "Los Angeles County", limit: "$1,249,125", floor: "High-Cost" },
  { county: "San Francisco County", limit: "$1,249,125", floor: "High-Cost" },
  { county: "Orange County", limit: "$1,249,125", floor: "High-Cost" },
  { county: "San Diego County", limit: "$1,077,550", floor: "High-Cost" },
  { county: "Sacramento County", limit: "$832,750", floor: "High-Cost" },
...
const faqItems = [
  ...
  {
    question: "What are the FHA loan limits in California for 2026?",
    answer:
  ...
  return (
    <>
      <StructuredData
        ...
        pageDescription="Compare FHA loan rates in California with just 3.5% down and 580 credit score. Government-backed mortgages with low closing costs for first-time homebuyers."
          ...
          <div className="container mx-auto px-4 relative">
            <div className="max-w-4xl mx-auto text-center">
              ...
              <nav className="flex justify-center items-center gap-2 text-sm text-gray-500 mb-6">
                ...
                <span>/</span>
                <span className="text-teal-600">FHA Loans</span>
              </nav>

              <div className="inline-flex items-center gap-2 bg-emerald-50 border border-emerald-500/30 text-emerald-600 px-4 py-1.5 rounded-full text-sm font-medium mb-6">
                <Shield className="h-4 w-4" />
                Government-Backed Mortgage
              </div>

              <h1 className="text-4xl sm:text-5xl lg:text-6xl font-bold text-gray-900 leading-tight mb-6">
                California <span className="text-teal-600">FHA Loans</span>
                <br />
              ...
              <div className="flex flex-col sm:flex-row gap-4 justify-center">
                ...
                >
                  <Link href="/get-quote">
                    Compare FHA Rates <ArrowRight className="ml-2 h-5 w-5" />
                  </Link>
                </Button>
                <Button
                  size="lg"
        ...
        <section className="py-20 border-t border-gray-200 bg-gray-50/50">
          <div className="container mx-auto px-4">
            <div className="max-w-4xl mx-auto">
              ...
              <div className="mt-8 p-6 bg-emerald-50 border border-emerald-500/30 rounded-xl">
                <div className="flex items-start gap-4">
                  <CheckCircle className="h-6 w-6 text-emerald-600 flex-shrink-0 mt-1" />
                  <div>
                    <h3 className="text-gray-900 font-semibold mb-2">First-Time Buyer Bonus</h3>
              ...
              <div className="bg-gray-50 rounded-2xl border border-gray-200 overflow-hidden">
                ...
                {californiaFhaLimits.map((item, index) => (
                  ...
                  >
                    ...
                    <span className="text-gray-500">{item.floor}</span>
                  </div>
                ))}
              </div>
            ...
            <div className="max-w-4xl mx-auto">
              ...
              <div className="grid md:grid-cols-2 gap-6">
                <div className="bg-gray-50 rounded-2xl p-6 border border-gray-200">
                  <h3 className="text-xl font-bold text-gray-900 mb-4">Upfront MIP</h3>
                  <div className="text-4xl font-bold text-teal-600 mb-2">1.75%</div>
                  <p className="text-gray-500 mb-4">of base loan amount</p>
                ...
                <div className="bg-gray-50 rounded-2xl p-6 border border-gray-200">
                  <h3 className="text-xl font-bold text-gray-900 mb-4">Annual MIP</h3>
                  <div className="text-4xl font-bold text-teal-600 mb-2">0.55%</div>
                  <p className="text-gray-500 mb-4">of loan amount per year</p>
                  <ul className="space-y-2 text-sm text-gray-600">
                    <li className="flex items-center gap-2">
                      <CheckCircle className="h-4 w-4 text-emerald-600" />
          ...
          <div className="container mx-auto px-4">
            <div className="max-w-4xl mx-auto">
              <div className="text-center mb-12">
                ...
                <p className="text-gray-500">Find the right loan type for your situation</p>
              </div>
        ...
        <section className="py-20 border-t border-gray-200 bg-gradient-to-b from-gray-50 to-white">
          <div className="container mx-auto px-4 text-center">
            ...
            <p className="text-xl text-gray-500 mb-8 max-w-2xl mx-auto">
              ...
              scores. Compare rates in 60 seconds with no credit impact.
            </p>
            <Button
              size="lg"
